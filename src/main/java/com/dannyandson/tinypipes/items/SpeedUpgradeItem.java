...
public class SpeedUpgradeItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> list, TooltipFlag flags) {
        if (Screen.hasShiftDown()) {
            String message = new TranslatableComponent("message." + this.getDescriptionId()).getString()
            ...
            list.add(new TranslatableComponent(message).withStyle(ChatFormatting.DARK_AQUA));
        } else
            list.add(new TranslatableComponent("tinypipes.tooltip.press_shift").withStyle(ChatFormatting.DARK_GRAY));
    }

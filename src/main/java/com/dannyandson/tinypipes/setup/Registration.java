...
public class Registration {
    ...
    private static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, TinyPipes.MODID);
    ...
    public static final TagKey<Block> MINEABLE_WITH_WRENCH = BlockTags.create(new ResourceLocation(TinyPipes.MODID,"mineable/wrench"));

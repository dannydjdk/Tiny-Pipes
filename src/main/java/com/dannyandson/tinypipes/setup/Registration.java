...
public class Registration {
    ...
    public static final RegistryObject<ContainerType<FluidFilterContainerMenu>> FLUID_FILTER_MENU_TYPE = MENU_TYPES.register("fluid_filter", () -> new ContainerType<>(FluidFilterContainerMenu::createFluidMenu));

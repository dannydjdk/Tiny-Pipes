...
public abstract class AbstractFullPipe implements IPipe {
    ...
    /**
     * Append human-readable lines describing this pipe and the end being looked at, for overlay mods
     * such as The One Probe and Jade. The base implementation reports the queried side's connection state,
     * but only at an I/O end — between two pipes the state isn't relevant.
     * Subclasses override to add type-specific details, calling {@code super} first.
     */

...
public class ModWidget extends AbstractWidget {
    ...
    private ModWidget.HAlignment halignment = ModWidget.HAlignment.LEFT;
    private ModWidget.VAlignment valignment = ModWidget.VAlignment.TOP;
    ...
    public ModWidget setTextHAlignment(ModWidget.HAlignment alignment) {
        this.halignment = alignment;
        return this;
    }
    public ModWidget setTextVAlignment(ModWidget.VAlignment alignment) {
